...
const luxuryButtonVariants = cva(
  "inline-flex items-center justify-center font-sans text-sm font-normal tracking-[0.04em] rounded-sm transition-all duration-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
